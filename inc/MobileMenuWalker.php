...
final class MobileMenuWalker extends \Walker_Nav_Menu
{
  ...
  private const BUTTON_TOP = "flex w-full items-center justify-between px-5 py-3 text-left text-sm text-stone-600 transition-colors hover:bg-stone-50 hover:text-stone-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-inset";
  private const BUTTON_SUB = "flex h-11 w-11 shrink-0 items-center justify-center text-stone-400 transition-colors hover:text-stone-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-inset";
